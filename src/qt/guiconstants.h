...
/* GRCoinGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* GRCoinGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "GRCoin"
#define QAPP_ORG_DOMAIN "grcoin.com"
#define QAPP_APP_NAME_DEFAULT "GRCoin-Qt"
#define QAPP_APP_NAME_TESTNET "GRCoin-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "GRCoin-Qt-%s"
#define QAPP_APP_NAME_REGTEST "GRCoin-Qt-regtest"

    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about) {
        ...
        QString header = "Usage:\n"
                         "  grcoin-qt [command-line options]                     \n";
...
All the GRCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 GRR, 0.01 GRR, 0.1 GRR, 1 GRR and 10 GRR -- sort of like the paper money you use every day.</li> \

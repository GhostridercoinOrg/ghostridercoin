...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsMenuAction->setStatusTip(tr("Send coins to a GRCoin address"));
    sendCoinsMenuAction->setToolTip(sendCoinsMenuAction->statusTip());

    coinJoinCoinsMenuAction = new QAction("&CoinJoin", this);
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a GRCoin address").arg("CoinJoin"));
    coinJoinCoinsMenuAction->setToolTip(coinJoinCoinsMenuAction->statusTip());

    receiveCoinsMenuAction = new QAction(tr("&Receive"), this);
    receiveCoinsMenuAction->setStatusTip(tr("Request payments (generates QR codes and grcoin: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about GRCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your GRCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified GRCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a grcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QIcon(":/icons/configure"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible GRCoin command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    switch (count) {
    case 0: icon = "connect_0"; color = GUIUtil::ThemedColor::ICON_ALTERNATIVE_COLOR; break;
    case 1: icon = "connect_1"; break;
    case 2: icon = "connect_2"; break;
    case 3: case 4: icon = "connect_3"; break;
    case 5: case 6: icon = "connect_4"; break;
    case 7: case 8: icon = "connect_5"; break; 
    default: icon = "connect_5"; color = GUIUtil::ThemedColor::GREEN; break;
    }
    ...
    if (fNetworkActive) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GRCoin network", "", count));
    } else {
...
void BitcoinGUI::updateWidth()
{
    ...
    // Use nButtonsVisible + 1 <- for the grcoin logo
...
{
    QString strTitle = tr("GRCoin Core"); // default title

...
/** Utility functions used by the GRCoin Qt UI.
 */
namespace GUIUtil {
...
// Parse "grcoin:" URI into recipient object, return true on successful parsing
...
/** Load grcoin specific appliciation fonts */
bool loadFonts();
...
/** Check if a grcoin specific theme is activated (light/dark).*/

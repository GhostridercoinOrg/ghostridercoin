...
#error Client version information missing: version is not defined by grcoin-config.h or in any other way
#endif
...
/**
 * grcoind-res.rc includes this file, but it cannot cope with real c++ code.

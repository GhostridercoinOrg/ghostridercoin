...
//! Interface for the src/evo part of a grcoin node (grcoind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a grcoin node (grcoind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a grcoin node (grcoind process).
namespace Smartnode {
class Sync
{
public:
...
//! Top-level interface for a grcoin node (grcoind process).
class Node
{
public:
    virtual ~Node() {}

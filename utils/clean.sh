...
rm -f src/config/grcoin-config.h
...
rm -rf test_bitcoin.coverage/ grcoin-gtest.coverage/ total.coverage/
...
clean_exe src/grcoin-cli
clean_exe src/grcoind
clean_exe src/grcoin-gtest
clean_exe src/grcoin-tx
clean_exe src/test/test_grcoin
clean_exe src/test/test_grcoin_fuzzy
...
clean_dep . src/config/grcoin-config.h.in

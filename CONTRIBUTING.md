# Contributing to GRCoin Core

The GRCoin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/GRCoin-Coin/Core-Wallet/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GRCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall GRCoin
Network Protocol consensus changes.

Whether a pull request is merged into GRCoin Core rests with the project merge
...
Patches that change GRCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the GRCoin consensus, it must have been
...
The review process is normally fairly responsive on the GRCoin Core repository, however
...
The project leader is the release manager for each GRCoin Core release.

...
"""Verify that starting grcoind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start grcoind with -h for help text")
        ...
        self.log.info("Start grcoind with -version for version information")

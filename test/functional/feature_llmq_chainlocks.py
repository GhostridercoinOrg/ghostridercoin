...
from test_framework.test_framework import GRCoinTestFramework
...
class LLMQChainLocksTest(GRCoinTestFramework):
    def set_test_params(self):
        self.set_grcoin_test_params(6, 5, fast_dip3_enforcement=True)

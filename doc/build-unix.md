...
Some notes on how to build GRCoin Core in Unix.

(for OpenBSD specific instructions, see [build-openbsd.md](build-openbsd.md))

## Base build dependencies

Building the dependencies and GRCoin Core requires some essential build tools and libraries to be installed before.
...
To help make your GRCoin installation more secure by making certain attacks impossible to
...
-   Non-executable Stack
    ...
    vulnerable buffers are found. By default, GRCoin Core should be built with a non-executable stack
...
When the intention is to run only a P2P node without a wallet, GRCoin Core may be compiled in
